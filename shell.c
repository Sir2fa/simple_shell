 ...
 */
 int main(int argc, char *argv[], char *env[])
 {
    ...
    while (++counter && non_int_count)
    {
        ...
        else if (o_mode == INTERACTIVE_FILE)
 ...
 /**
  * print_list - print the list of the path
  * @p: Referrence to the list of paths.
  ...
  */
  ...
  /**
   * set_list_env - set the enviroment list.
   * @p: Reference to the list of paths.
   */
     ...
     * Return: The size of the list.
     */
     size_t env_env_len(const _list_paths *p)
     {
        int size = 0;
     ...
     /**
      * is_not-built_in - Execute non-built-in commands.
